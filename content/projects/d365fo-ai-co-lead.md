...
download: "https://github.com/vjanardhana12/d365fo-ai-co-lead/releases/latest"
...
1. Click **Download** above to grab the latest VSIX from GitHub Releases, then run:
   ```
   code --install-extension d365fo-ai-co-lead-1.1.0.vsix
   ```
...
4. Set your role(s): VS Code Settings → `d365fo.myRoles` (multi-select supported, e.g. `developer + dev-lead`).
...
Distributed via [GitHub Releases](https://github.com/vjanardhana12/d365fo-ai-co-lead/releases/latest) — public, no Marketplace required, no PAT for end users. Open source under MIT License. v1.0 ships the platform; v1.1 wires AI mode end-to-end (FDD/TDD/test-case generators, PR triage, defect triage). See [ROADMAP](https://github.com/vjanardhana12/d365fo-ai-co-lead/blob/main/ROADMAP.md).
---
title: "D365 F&O AI Co-Lead"
description: "VS Code extension - your AI partner across the F&O delivery lifecycle. Six role-aware Copilot Chat partners, in-product Agent Factory, role-filtered dashboard."
date: 2026-05-01
...
1. Click **Download** above to get the latest VSIX, then run: `code --install-extension d365fo-ai-co-lead-1.1.0.vsix`.
2. Open the **D365 F&O** activity bar -> **Open Dashboard**.
3. Add an Identity (ADO email + PAT) -> add a Project Connection (or import via Project Initiation Kit).
